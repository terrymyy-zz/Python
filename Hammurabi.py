...
def Hammurabi():
    ...
    print "You are in year " + str(0) + " of your ten year rule."
    print "In this year " + str(starved) +" people starved to death."
    print "In this year " + str(immigrants)+ " people entered the kingdom."
    print "The population is now " + str(population) + "."
    print "We can harvest bushels at " + str(bushels_per_acre) + " bushels per acre."
    ...
    for year in range(1,10):
        ...
        bushels_in_storage -= acres_plant
    ...
    elif starved<5 and acres_owned / population > 10.0:
...
def doRatsInfest(): 
    if random.randint(1, 100) > 40:
        ...
        return int(random.randint(10, 30)/100.0)
